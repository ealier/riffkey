...
(function () {
  ...
  const RULES = [
    ...
    {
      re: /оплат|плат|карт|юкасс|yookassa|сбп|наличн/i,
      text: 'Способы оплаты и безопасность платежей описаны на странице «Оплата».',
    ...
    },
    {
      ...
      text: 'Телефон 79510337306, почта arshanovraf@bk.ru. Адрес самовывоза и карта — в разделе «Контакты».',
